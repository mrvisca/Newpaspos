...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Pas POS - Pendaftaran</title>
    ...
    <body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static   menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                    ...
                    <div class="auth-wrapper auth-v2">
                        <div class="auth-inner row m-0">
                            ...
                            <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                                <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="../assets/tema/template/app-assets/images/pages/register-v2.svg" alt="Register V2" /></div>
                            </div>
                            <!-- /Left Text-->
                            <!-- Register-->
                            <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                    ...
                                    <form class="auth-register-form mt-2" action="proses/proses_register.php" method="POST">
                                        <div class="mb-1">
                                            <label class="form-label" for="register-username">Nama Toko</label>
                                            <input class="form-control" id="register-username" type="text" name="nama" placeholder="Toko Serba Ada" aria-describedby="register-username" autofocus="" tabindex="1" required/>
                                        </div>
                                        <div class="mb-1">
                                            <label class="form-label" for="register-username">Username</label>
                                            <input class="form-control" id="register-username" type="text" name="user" placeholder="johndoe" aria-describedby="register-username" autofocus="" tabindex="1" required/>
                                        </div>
                                        <div class="mb-1">
                                            <label class="form-label" for="register-password">Password</label>
                                            <div class="input-group input-group-merge form-password-toggle">
                                                <input class="form-control form-control-merge" id="register-password" type="password" name="pass" placeholder="············" aria-describedby="register-password" tabindex="3" required/><span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                                            </div>
                                        </div>
                                        <div class="mb-1">
                                            <label class="form-label" for="register-password">Ulangi Password</label>
                                            <div class="input-group input-group-merge form-password-toggle">
                                                <input class="form-control form-control-merge" id="register-password" type="password" name="pass1" placeholder="············" aria-describedby="register-password" tabindex="3" required/><span class="input-group-text cursor-pointer"><i data-feather="eye"></i></span>
                                            </div>
                                        </div>
                                        <div class="mb-1">
                                            <label class="form-label" for="register-email">No Wa</label>
                                            <input class="form-control" id="register-email" type="number" name="nohp" placeholder="62821xxxxxxxx" aria-describedby="register-email" tabindex="2" required/>
                                        </div>
                                        <div class="mb-1">
                                    ...
                                    <p class="text-center mt-2"><span>Sudah punya akun?</span><a href="login.php"><span>&nbsp;Login sekarang</span></a></p>
                                    <p class="text-center mt-2"><span>Pendaftaran Custom?</span><a href="login.php"><span>&nbsp;Klik Disini</span></a></p>
                                </div>
                            </div>
                            <!-- /Register-->
                        </div>
        ...
        <!-- BEGIN: Page JS-->
        <script src="../assets/tema/template/app-assets/js/scripts/pages/page-auth-register.js"></script>
        <!-- END: Page JS-->
