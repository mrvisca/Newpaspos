<html>
    ...
    <body>
        <?php
            ...
            $query_insert_pegawai = "INSERT INTO employee (id_brand,user,pass,id_branch,nama,email) VALUES ('".$id_brand."','".$user."','".$pass."','".$id_branch."','".$nama."','".$email."')";
            $data_pegawai = $koneksi->prepare($query_insert_pegawai);
