...
<html class="loading" lang="en" data-textdirection="ltr">
    ...
    <head>
        ...
        <title>Pas POS - Lupa Password</title>
    ...
    <body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static   menu-collapsed" data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                    ...
                    <div class="auth-wrapper auth-v2">
                        <div class="auth-inner row m-0">
                            ...
                            <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                                <div class="w-100 d-lg-flex align-items-center justify-content-center px-5"><img class="img-fluid" src="../assets/tema/template/app-assets/images/pages/forgot-password-v2.svg" alt="Forgot password V2" /></div>
                            </div>
                            <!-- /Left Text-->
                            <!-- Forgot password-->
                            <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                                <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                    ...
                                    <p class="card-text mb-2">Masukan username dan klik reset password, password akan dikirim via email terdaftar</p>
                                    <form class="auth-forgot-password-form mt-2" action="proses/proses_forgotpass.php" method="POST">
                                        <div class="mb-1">
                                            <label class="form-label" for="forgot-password-email">Username</label>
                                            <input class="form-control" id="forgot-password-email" type="text" name="user" placeholder="demo" aria-describedby="forgot-password-email" autofocus="" tabindex="1" required/>
                                        </div>
                                        <button class="btn btn-primary w-100" tabindex="2">Request Password</button>
                                    </form>
                                    <p class="text-center mt-2"><a href="login.php"><i data-feather="chevron-left"></i> Kembali ke Login</a></p>
                                </div>
                            </div>
                            <!-- /Forgot password-->
                        </div>
        ...
        <!-- BEGIN: Page JS-->
        <script src="../assets/tema/template/app-assets/js/scripts/pages/page-auth-forgot-password.js"></script>
        <!-- END: Page JS-->
